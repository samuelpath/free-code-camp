...
const getSymmetricDifferenceBetween2orMoreArrays = () => [...arguments].reduce(getSymmetricDifferenceBetween2Arrays);

const getSymmetricDifferenceBetween2Arrays = (a, b) => relativeComplementsArg2minusArg1(b, a).concat(relativeComplementsArg2minusArg1(a, b));

const relativeComplementsArg2minusArg1 = (a, b) => {
  b.filter((element) => {
    a.indexOf(element) === -1;
  });
};